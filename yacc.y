...
return_statement: DON expression
       | DON SC
...
function_call : function_name LP function_expression_list RP | function_name LP RP
function_expression_list : expression 
       | expression COMMA function_expression_list

variable_type : BOOL_DEF 
       | FLOAT_DEF 
       | INTEGER_DEF 
       | KOVA_DEF 
       | KOVA_DEF LESS_THAN variable_type GREATER_THAN
...
expression : expression PLUS term 
       ...
       | term
term : term MULT power 
       | term DIV power
       | power
power : power EXPONENT factor 
       | mod
mod : mod MOD factor 
       | factor
...
array_index : LSB expression RSB 
       | array_index LSB expression RSB

constant : boolean_var 
       | int_var 
       | float_var

update_statement : variable_name DECREASE 
       | variable_name INCREASE

assignment_statement : variable ASSIGN expression 
       | variable_name ASSIGN expression 
       | variable_name array_index ASSIGN expression

kova_items: expression 
       | expression COMMA kova_items
...
for_statement : FOR LP assignment_statement SC conditions SC update_statement RP block 
       | FOR LP assignment_statement SC conditions SC assignment_statement RP block
...
function_variable_list : variable 
       | variable COMMA function_variable_list
function_body : LP RP
